...
def run_generation():
    ...
    if args.lang:
        pth = f'/content/results/crosslingual/{args.version}'
    else:
        pth = f'/content/results/{args.version}'
    if args.baseline:
...
if __name__ == "__main__":
    ...
    if args.lang:
        fname = f'/content/workspace/repositories/norms/crosslingual/{args.version}/retriever_processed_norms_cl'
        retriever = load_from_disk(fname + f'_train_{args.lang}{filt}')
        test_data = load_from_disk(fname + f'_test_{args.lang}_unfiltered')
    else:
        fname = f'/content/workspace/repositories/norms/{args.version}/retriever_processed_norms'
    ...
    if args.simulate:
        ...
        ids = np.loadtxt('/content/results/simulation_baseFalse.txt')
